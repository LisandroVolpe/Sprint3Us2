...
class Test_001(unittest.TestCase):
    ...
    def test_grimoldi(self):
        ...
        #elegir zapas
        elegir_btn = self.driver.find_element(By.ID, "li32416")
        elegir_btn.click()
        
        talle_btn = self.driver.find_element(By.ID, "49")
        talle_btn.click()
        ...
        search_input = self.driver.find_element(By.ID, "textoBusqueda")
        search_input.send_keys("medias")
        search_input.send_keys(Keys.RETURN)
        
        time.sleep(2)
        
        medias_btn = self.driver.find_element(By.ID, "slider31165")
        medias_btn.click()
        ...
        #carrito
        carrito_btn = self.driver.find_element(By.ID, "linkCarrito")
        carrito_btn.click()
