...
class Test_001(unittest.TestCase):
    ...
    def test_grimoldi(self):
        ...
        search_input.send_keys("zapatos")
        ...
        #elegir 
        elegir_btn = self.driver.find_element(By.ID, "slider3674")
        elegir_btn.click()
        
        talle_btn = self.driver.find_element(By.ID, "73")
        talle_btn.click()
        ...
        search_input = self.driver.find_element(By.ID, "textoBusqueda")
        search_input.send_keys("billetera")
        search_input.send_keys(Keys.RETURN)
        
        time.sleep(2)
        
        medias_btn = self.driver.find_element(By.ID, "slider30923")
        medias_btn.click()
        
        talle_m_btn = self.driver.find_element(By.ID, "121")
        talle_m_btn.click()
        ...
        eliminar_btn = self.driver.find_element(By.CLASS_NAME, "btnDeleteCompraCarroLinea")
        eliminar_btn.click()
        ...
        #finalzar compra
        Finalizar_btn = self.driver.find_element(By.ID, "finializarCompraCarro")
        Finalizar_btn.click()
